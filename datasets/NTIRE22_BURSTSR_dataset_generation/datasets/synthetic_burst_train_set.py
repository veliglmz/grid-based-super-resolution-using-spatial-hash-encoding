...
class SyntheticBurst(torch.utils.data.Dataset):
    ...
    """
    def __init__(self, base_dataset, downsample_factor=4, burst_size=14, crop_sz=384, transform=tfm.ToTensor()):
        ...
        self.burst_transformation_params = {'max_translation': 2.0,
                                            'max_rotation': 2.0,
                                            'max_shear': 0.0,
                                            'max_scale': 0.0,
                                            'border_crop': 12}
